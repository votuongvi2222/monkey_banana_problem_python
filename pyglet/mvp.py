...
def main():
    ...
    crate = TextureLoader.load_texture("obj_files/crate.jpg")
    metal = TextureLoader.load_texture("obj_files/metal.jpg")
    brick = TextureLoader.load_texture("obj_files/brick.jpg")
